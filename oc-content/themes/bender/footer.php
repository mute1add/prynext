...
<div id="footer">
    <div class="wrapper">
        ...
        <?php if( (!defined('MULTISITE') || MULTISITE==0) && osc_get_preference('footer_link', 'bender') !== '0') {
            echo '<div>' . sprintf(__('Created by <a title="iBit Progress" href="http://ibitprogress.com">iBit Progress</a> <strong>All rights reserved</strong>'), 'http://ibitprogress.com') . '</div>';
        }
        ?>
